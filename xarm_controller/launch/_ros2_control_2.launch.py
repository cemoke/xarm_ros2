...
def launch_setup(context, *args, **kwargs):
    ...
    if not ros2_control_params.perform(context):
        ...
        ros2_control_params = generate_ros2_control_params_temp_file(
            ...
            ros_namespace=LaunchConfiguration("ros_namespace", default="").perform(
                context
            ),
    ...
    if not robot_description.perform(context):
        ...
        robot_description = yaml.load(
            robot_description.perform(context), Loader=yaml.FullLoader
        )
    ...
    ros2_control_node = Node(
        ...
        output="screen",
        remappings=[
            ("cartesian_motion_controller/target_frame", "teleop_target_frame"),
            ...
            (
                "end_effector_controller/ft_sensor_wrench",
    ...
    #     executable="xarm_ros2_control_node",
    #     parameters=[
    #         robot_description,
    #         ros2_control_params,
    #         robot_params,
